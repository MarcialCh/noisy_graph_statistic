...
def load_edges():
    global network
    edge_file = open("D:/file/noisy_graph_statistic/src/astroPh.txt", "r")
...
if __name__ == '__main__':
    ...
    for variance in range(1, 6):
        total_price = degree.total_price_from_variance(network, 20 * variance, price_points, 1)
    ...
    for data_proportion in range(1, 11):
        ...
        total_price = degree.total_price_from_variance(subgraph, 20, price_points,  1)
