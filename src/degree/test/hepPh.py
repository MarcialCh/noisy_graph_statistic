...
if __name__ == '__main__':
    ...
    for epsilon in range(-6, 4):
        ...
        perturbed_answer = degree.total_num_from_privacy_budget(node_degree, 10 ** epsilon, k)
        total = 0
    ...
    for data_proportion in range(1, 11):
        ...
        total_price = degree.total_price_from_variance(sub_subgraph_numbers, 20, price_points, 10**3)
