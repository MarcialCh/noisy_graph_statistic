...
import os.path
from src.k_star import baseline, upper
...
if __name__ == '__main__':
    ...
    for variance in range(1, 6):
        ...
        total_price = upper.total_price_from_variance(network, 10 * variance, price_points, k, 10 ** 2.5, 1000)
    ...
    for data_proportion in range(1, 11):
        ...
        total_price = upper.total_price_from_variance(subgraph, 10, price_points, k, 10 ** 2, 1000)
    ...
    for k_examine in range(2, 11):
        ...
        total_price = upper.total_price_from_variance(subgraph, 10, price_points, k_examine, 10 ** 2, 1000)
