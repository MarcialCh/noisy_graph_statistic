...
We implemented the proposed algorithms:\textsf{Degree}, \textsf{LS'}$k$-star and \textsf{Two-phase} for calculating the information contribution and answers of node degrees, $k$-stars and $k$-cliques respectively.
